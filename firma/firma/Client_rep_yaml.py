...
class Client_rep_yaml(Client):

    def __init__(self, *args, **kwargs):
        super(Client_rep_yaml, self).__init__(*args, **kwargs)

    @classmethod
    def read(cls, skip=0, count=None):
        clients = []
        data, _ = Client_rep_yaml.__get_data_from_file()
        for entry in data:
    ...
    def save(cls, clients):
        ...
        data, ids = Client_rep_yaml.__get_data_from_file()
        ...
        Client_rep_yaml.__write_data_to_file(data)
    ...
    @classmethod
    def get_count(cls):
        return len(Client_rep_yaml.read())
